...
namespace EbuBridgeLmsSystem.Persistance.Data.Migrations
{
    ...
    [Migration("20250207205625_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Persistance.IdentityEntity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.Address", b =>
                {
                    b.HasOne("EbuBridgeLmsSystem.Domain.Entities.User", "User")
                        .WithOne("Address")
                        .HasForeignKey("EbuBridgeLmsSystem.Domain.Entities.Address", "UserId")
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.Parent", b =>
                {
                    b.HasOne("EbuBridgeLmsSystem.Domain.Entities.User", "User")
                        .WithOne("Parent")
                        .HasForeignKey("EbuBridgeLmsSystem.Domain.Entities.Parent", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.Report", b =>
                {
                    ...
                    b.HasOne("EbuBridgeLmsSystem.Domain.Entities.User", "ReportedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.Student", b =>
                {
                    ...
                    b.HasOne("EbuBridgeLmsSystem.Domain.Entities.User", "User")
                        .WithOne("Student")
                        .HasForeignKey("EbuBridgeLmsSystem.Domain.Entities.Student", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.Teacher", b =>
                {
                    b.HasOne("EbuBridgeLmsSystem.Domain.Entities.User", "User")
                        .WithOne("Teacher")
                        .HasForeignKey("EbuBridgeLmsSystem.Domain.Entities.Teacher", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EbuBridgeLmsSystem.Domain.Entities.User", b =>
                {
                    b.HasOne("EbuBridgeLmsSystem.Persistance.IdentityEntity.AppUser", null)
                        .WithOne("DomainUser")
                        .HasForeignKey("EbuBridgeLmsSystem.Domain.Entities.User", "AppUserId");
                });
